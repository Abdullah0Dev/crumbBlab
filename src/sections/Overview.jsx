          ...
          <motion.div className="overview flex flex-col items-start mt-2 gap-y-2">
            <motion.div
              ...
              <h2 className="flex-wrap flex text-wrap">
                Augen is the first-of-its-kind AI Wearable Company bringing general-purpose devices
              </h2>
              <motion.h2
                initial={{ y: 20 }}
                whileInView={{ y: 0 }}
                transition={{ duration: 0.7, ease: 'easeOut' }}
                className="text-[#0771E3]">
            ...
            <motion.a
              ...
              <button className="border border-[#0771E3] py-[1px] px-1 rounded-full">
                {' '}
                <FaArrowRightLong color="#0771E3" size={10} />
              </button>
