...
const ServiceItem = ({ yellowCircle, serviceCategory, serviceSection, data, isActive }) => {
  return (
      ...
      <div className="max-w-2xl">
        <div className="flex gap-x-32">
          <motion.div
            ...
            className="w-32"
          >
            <div className={`text-center w-16 items-center p-1 rounded-full ${isActive ? 'bg-yellow-500' : 'bg-black-500'}`}>
          ...
          <motion.div className="w-80">
            <h2 className="text-md text-white/60">{serviceSection}</h2>
